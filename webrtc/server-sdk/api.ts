...
export type Component =
  ...
  | ({ type: "hls" } & ComponentHLS)
  | ({ type: "recording" } & ComponentRecording)
  | ({ type: "rtsp" } & ComponentRTSP)
  | ({ type: "sip" } & ComponentSIP);
...
export type ComponentOptionsHLSSubscribeModeEnum =
  (typeof ComponentOptionsHLSSubscribeModeEnum)[keyof typeof ComponentOptionsHLSSubscribeModeEnum];
...
export type ComponentPropertiesHLSSubscribeModeEnum =
  (typeof ComponentPropertiesHLSSubscribeModeEnum)[keyof typeof ComponentPropertiesHLSSubscribeModeEnum];
...
export type HealthReportStatus =
  (typeof HealthReportStatus)[keyof typeof HealthReportStatus];
...
export type RoomConfigVideoCodecEnum =
  (typeof RoomConfigVideoCodecEnum)[keyof typeof RoomConfigVideoCodecEnum];
  ...
  return {
    ...
    > {
      ...
      const operationBasePath =
        operationServerMap["HealthApi.healthcheck"]?.[index]?.url;
 ...
 * @export
 */
export const HlsApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
    ...
    subscribeHlsTo: async (
      ...
      const localVarPath = `/hls/{room_id}/subscribe`.replace(
        `{${"room_id"}}`,
...
export const HlsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getHlsContent(
        roomId,
        filename,
        range,
        hLSMsn,
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["HlsApi.getHlsContent"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.subscribeHlsTo(
        roomId,
        subscriptionConfig,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["HlsApi.subscribeHlsTo"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const HlsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    subscribeHlsTo(
      ...
      return localVarFp
        .subscribeHlsTo(roomId, subscriptionConfig, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class HlsApi extends BaseAPI {
  ...
  public getHlsContent(
    ...
    return HlsApiFp(this.configuration)
 ...
 * @export
 */
export const RecordingApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
    ...
    deleteRecording: async (
      ...
      const localVarPath = `/recording/{recording_id}`.replace(
        `{${"recording_id"}}`,
...
export const RecordingApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    RecordingApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Deletes the recording
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RecordingApi.deleteRecording"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getRecordingContent(
          recordingId,
          filename,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RecordingApi.getRecordingContent"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getRecordings(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RecordingListResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getRecordings(options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RecordingApi.getRecordings"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const RecordingApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export const RoomApiAxiosParamCreator = function (
  ...
  return {
    ...
    addComponent: async (
      ...
      const localVarPath = `/room/{room_id}/component`.replace(
        `{${"room_id"}}`,
        encodeURIComponent(String(roomId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    addPeer: async (
      ...
      const localVarPath = `/room/{room_id}/peer`.replace(
        `{${"room_id"}}`,
        encodeURIComponent(String(roomId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deleteRoom: async (
      ...
      const localVarPath = `/room/{room_id}`.replace(
        `{${"room_id"}}`,
        encodeURIComponent(String(roomId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const RoomApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addComponent(
        roomId,
        addComponentRequest,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.addComponent"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addPeer(
        roomId,
        addPeerRequest,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.addPeer"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async createRoom(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RoomCreateDetailsResponse>
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.createRoom"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async deleteComponent(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteComponent(
        roomId,
        id,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.deleteComponent"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async deletePeer(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deletePeer(
        roomId,
        id,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.deletePeer"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.deleteRoom"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getAllRooms(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RoomsListingResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllRooms(options);
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.getAllRooms"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getRoom(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RoomDetailsResponse>
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.getRoom"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const SipApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const SipApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async dial(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.dial(
        roomId,
        componentId,
        dialConfig,
        options,
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath = operationServerMap["SipApi.dial"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["SipApi.endCall"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const SipApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class SipApi extends BaseAPI {
  ...
  public dial(
    ...
    return SipApiFp(this.configuration)
      .dial(roomId, componentId, dialConfig, options)
      .then((request) => request(this.axios, this.basePath));
  }
